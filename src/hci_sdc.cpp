...
/* -------------------------------------------------------------------------
 * Core HCI compatibility commands not present in the local vendor dispatch.
 * ------------------------------------------------------------------------- */
                                                       ...
                                                       size_t ReturnCapacity)
{
     ...
     * return value, so tests/command_coverage.py ties it independently to the
     * configured multirole resources: multiple Central and Peripheral links,
     * advertising and scan resources, and explicit parallel scanning plus
     * initiating support. The hardware profile test also pins the exact value
     * placed on the wire.
     */
                                                  ...
                                                  size_t)
{
    ...
    /*
     * The procedure completes asynchronously with LE Request Peer SCA Complete,
     * so the immediate HCI response is Command Status.
     */
    HciCmdResult_t result = {
