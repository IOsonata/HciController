...
@brief	Native Bluetooth USB HCI transport state and API.

		Defines descriptor modes, packet-oriented DeviceIntrf state, native
		USB endpoint buffers, transport diagnostics, and processing functions.
