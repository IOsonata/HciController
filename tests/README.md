...
| `hci_sdc_dispatch_test` | `hci_sdc_nrfxlib.cpp` | all 91 opcodes reach the intended SDC call with the right response type and parameter length, and the supported commands bitmap agrees with the table in both directions |
